  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-[14.5rem] right-6 md:bottom-[11rem] md:right-8 z-[60] w-14 h-14 bg-emerald-600 text-white rounded-full shadow-2xl flex flex-col items-center justify-center gap-0.5 group overflow-hidden border-2 border-white dark:border-zinc-900 cursor-grab active:cursor-grabbing"
      >
