...
export default function HomePage({ onNavigate, deepThinking, setDeepThinking }: HomePageProps) {
  ...
  const quickActions = [
    ...
    { id: 'who-am-i', label: 'Quem Somos?', desc: 'Nossa história.', icon: <User size={20} className="text-red-600" />, color: 'bg-red-50 dark:bg-red-900/20 shadow-red-100/50', image: '/logo.png' },
